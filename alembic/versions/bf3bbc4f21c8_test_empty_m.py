...
Revision ID: bf3bbc4f21c8
Revises: 7849fbaaefd2
Create Date: 2025-05-05 14:34:11.589000
...
def upgrade() -> None:
    ...
    sa.Column('doctor_id', sa.String(length=36), nullable=False),
    sa.Column('status', sa.Enum('registered', 'under_treatment', 'discharged', name='patientstatus'), nullable=False),
