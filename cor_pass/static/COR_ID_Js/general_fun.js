...
const modalConfigs = {
    ...
    step1Modal: { width: '460px', height: '690px', top: '20px', left: 'auto' },
    step2Modal: { width: '460px', height: '690px', top: '20px', left: 'auto' },
    step3Modal: { width: '460px', height: '690px', top: '20px', left: 'auto' },
    step4Modal: { width: '460px', height: '690px', top: '20px', left: 'auto' },
    step5Modal: { width: '460px', height: '690px', top: '20px', left: 'auto' },
