...
class CorporateClient(Base):
    ...
    company_name = Column(String(255), nullable=False, unique=True, comment="Полное название компании")
    ...
    tax_id = Column(String(50), nullable=False, unique=True, comment="ЄДРПОУ/ИНН")
